# Blog
이 프로젝트는 개인 프로젝트로 개발한 블로그 웹 애플리케이션입니다. 사용자는 게시글을 작성하고, 친구 관계 또는 다른 사용자들에게 공유 할 수 있으며, 게시글에 댓글을 남길 수 있습니다. 또한 프로필 이미지 변경, 친구 관리, 1:1 및 단체 실시간 채팅(WebSocket 기반) 기능도 제공합니다.
